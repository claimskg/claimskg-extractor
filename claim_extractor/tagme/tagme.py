...
class AnnotateResponse(object):
    ...
    def get_annotations(self, min_rho=None):
        ...
        :param min_rho: if set, only get claim_entities with a rho-score (confidence) higher than this.
        '''
...
class Relatedness(object):
    '''
    A relatedness, i.e. a real value between 0 and 1 indicating how semantically close two claim_entities
    are.
    '''
...
class RelatednessResponse(object):
    ...
    def get_relatedness(self, i=0):
        '''
        Get the relatedness of a pairs of claim_entities.
...
def annotate(text, gcube_token=None, lang=DEFAULT_LANG, api=DEFAULT_TAG_API,
    ...
    '''
    Annotate a text, linking it to Wikipedia claim_entities.
...
def relatedness_wid(wid_pairs, gcube_token=None, lang=DEFAULT_LANG, api=DEFAULT_REL_API):
    '''
    Get the semantic relatedness among pairs of claim_entities. Entities are indicated by their
