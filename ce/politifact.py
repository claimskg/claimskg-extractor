...
def get_all_claims(criteria):
	headers = {'user-agent': 'Mozilla/5.5 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36'}
	...
	for url, conclusion in urls_.iteritems():  
		...
		try: 
			...
			if (author and author.find("div",{"itemprop":"author"})):
				claim_.setAuthor(author.find("div",{"itemprop":"author"}).find("div",{"itemprop":"name"}).get_text())
